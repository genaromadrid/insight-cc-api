...
AddressController.prototype._populateMulsignValid = function(multisign,network){ 
 return new Promise((resolve,reject)=>{
  let p2sh_addresses=multisign.filter(function(multisign){ 
    let isValid=((Number.isInteger(multisign.reqSigs)&&(multisign.reqSigs>0)) && (multisign.reqSigs <= multisign.pub_keys.length));
    if (isValid){
